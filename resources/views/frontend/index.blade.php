                            ...
                            @foreach ($products as $product)
                                <div class="grid">
                                    <div class="product-pic">
                                        <img src="{{ asset('uploads/thumbnail_photo') }}/{{ $product->thumbnail }}"
                                            alt="asa">
                                        @if ($product->discount_price)
                                            <span
                                                class="theme-badge-2">{{ round(100 - ($product->discount_price / $product->reguler_price) * 100, 2) }}%
                                                off</span>
                                        @endif
                                    </div>
                                    <div class="details">
                                        ...
                                        <p><a href="{{ route('productdetails',$product->id) }}">{{ Str::limit($product->short_description, 15) }} </a></p>
                                        <div class="rating">
                                        ...
                                        <span class="price">
                                           ...
                                           @else
                                                ...
                                                <span class="woocommerce-Price-amount amount">
                                                    <bdi>
                                                        <span class="woocommerce-Price-currencySymbol">৳ </span>{{$product->reguler_price}}
                                                    </bdi>
                                                </span>
                                            </ins>
                                           @endif
                                        ...
                                        <div class="add-cart-area">
                                            <a class="add-to-cart btn btn-success" href="{{ route('productdetails',$product->id) }}">Details</a>
                                        </div>
                                    </div>
                                </div>
                            @endforeach
